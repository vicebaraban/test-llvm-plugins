...
!93 = distinct !DICompileUnit(language: DW_LANG_C11, file: !2, producer: "Ubuntu clang version 18.1.8 (++20240714071213+3b5b5c1ec4a3-1~exp1~20240714191314.138)", isOptimized: false, flags: "/usr/lib/llvm-18/bin/clang -O0 -S -emit-llvm -g tests/c/linpack.c -o tests/c/linpack_O0.dbg.ll", runtimeVersion: 0, emissionKind: FullDebug, retainedTypes: !94, globals: !102, splitDebugInlining: false, nameTableKind: None)
!94 = !{!95, !96, !97, !99}
